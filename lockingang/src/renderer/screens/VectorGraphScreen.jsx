    ...
    <div className="h-screen flex overflow-hidden bg-vector-bg text-vector-white font-terminal relative">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <header className="h-14 border-b border-vector-blue flex items-center justify-between px-6 backdrop-blur-md bg-vector-bg/40 z-10 shrink-0">
          ...
          {studyState.subject && (
            <span className="text-[9px] text-vector-white/40 font-mono">{studyState.subject}</span>
          )}
        </header>
          ...
          >
            ...
            {nodes.length === 0 && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 pointer-events-none">
                ...
                <p className="text-[11px] text-vector-white/20 font-mono text-center">
                ...
                return (
                  <div key={node.id} className="absolute flex flex-col items-center"
                    ...
                    <div className="relative">
                      <div style={{ width: sizePx, height: sizePx, borderWidth: node.isPrimary ? "2px" : "1px",
                    ...
                    <div style={{ marginTop: 8, padding: "2px 8px", border: `1px solid ${colors.border}`,
                      color: colors.label, fontSize: "8px", letterSpacing: "0.15em", textTransform: "uppercase",
            ...
            <div className="absolute bottom-6 left-6 z-20 flex items-center gap-3 pointer-events-auto">
              <button
                ...
                className="border border-vector-blue bg-vector-blue/10 px-5 py-2 flex items-center gap-2 hover:bg-vector-blue/30 transition-all text-vector-white text-[9px] tracking-widest uppercase"
              >
            ...
            <div className="w-80 flex-shrink-0 border-l border-vector-blue bg-vector-bg/95 backdrop-blur-md flex flex-col overflow-hidden z-30">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="px-4 py-3 border-b border-vector-blue/20">
                  <p className="text-[7px] text-vector-blue/40 font-mono tracking-widest uppercase mb-2">{selectedNode.id}</p>
                  {selectedStudyNode && (
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-[8px] font-mono text-vector-white/40">MASTERY</span>
                ...
                {/* Test Date */}
                <div className="px-4 py-3 border-b border-vector-blue/20">
                  <p className="text-[9px] text-vector-blue/50 font-mono tracking-widest uppercase mb-2">TEST_DATE</p>
                  {(() => {
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 bg-black/60 border border-vector-blue/20 px-2 py-1.5 text-vector-white/80 text-[10px] font-mono outline-none focus:border-vector-blue/60 transition-colors"
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 text-[9px] font-mono tracking-widest uppercase border transition-all
                          ...
                          {testDateInput && (
                            <button
                              ...
                              className="px-2 py-1.5 text-[9px] font-mono border border-red-500/30 text-red-400 hover:bg-red-500/10 transition-all"
                        ...
                        <p className="text-[8px] text-vector-white/30 font-mono">
                ...
                {/* AI Summary */}
                <div className="px-4 py-3 border-b border-vector-blue/20">
                  <p className="text-[7px] text-vector-blue/40 font-mono tracking-widest uppercase mb-2">AI_SUMMARY</p>
                  {!aiSummary && !summaryLoading && (
                    <button
                      onClick={loadSummary}
                      className="w-full py-2 border border-vector-blue/40 text-vector-blue text-[9px] font-mono tracking-widest uppercase hover:bg-vector-blue/10 transition-all flex items-center justify-center gap-2"
                    >
                  ...
                  {summaryLoading && (
                    <div className="flex items-center gap-2 py-2">
                      ...
                      <span className="text-[9px] text-vector-blue/60 font-mono">Generating...</span>
                    </div>
                  )}
                  {aiSummary && (
                ...
                <div className="px-4 py-3 border-b border-vector-blue/20 flex flex-col gap-2">
                  <button
                    ...
                    className="w-full py-2 border border-vector-blue/50 bg-vector-blue/10 text-vector-blue text-[9px] font-mono tracking-widest uppercase hover:bg-vector-blue/30 transition-all flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2 border border-vector-white/20 text-vector-white/60 text-[9px] font-mono tracking-widest uppercase hover:border-vector-blue hover:text-vector-blue transition-all flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2 border border-red-500/30 text-red-400 text-[9px] font-mono tracking-widest uppercase hover:bg-red-500/10 transition-all flex items-center justify-center gap-2"
                  >
                ...
                {selectedStudyNode?.attachedFiles?.length > 0 && (
                  <div className="px-4 py-3 border-b border-vector-blue/20">
                    <p className="text-[7px] text-vector-blue/40 font-mono tracking-widest uppercase mb-2">ATTACHED_FILES</p>
                    <div className="flex flex-col gap-1">
                      {selectedStudyNode.attachedFiles.map((f, i) => (
                        <div key={i} className="flex items-center gap-2 text-[9px] font-mono text-vector-white/60">
                ...
                <div className="px-4 py-3 flex flex-col gap-3">
                  <p className="text-[7px] text-vector-blue/40 font-mono tracking-widest uppercase">EDIT_NODE</p>
                  <div>
                    <label className="text-[7px] text-vector-white/30 font-mono uppercase tracking-widest block mb-1">Label</label>
                    <input
                      value={editLabel}
                      onChange={(e) => setEditLabel(e.target.value)}
                      className="w-full bg-black/60 border border-vector-blue/20 px-3 py-2 text-vector-white/80 text-[10px] font-mono outline-none focus:border-vector-blue/60 transition-colors"
                    />
                  </div>
                  <div>
                    <label className="text-[7px] text-vector-white/30 font-mono uppercase tracking-widest block mb-1">Description</label>
                    <textarea
                      value={editDescription}
                      onChange={(e) => setEditDescription(e.target.value)}
                      rows={4}
                      className="w-full bg-black/60 border border-vector-blue/20 px-3 py-2 text-vector-white/70 text-[10px] font-mono leading-relaxed resize-none outline-none focus:border-vector-blue/60 transition-colors"
                    />
                  </div>
                  <button
        ...
        <div className="absolute inset-0 z-50 bg-vector-bg/70 backdrop-blur-sm flex items-center justify-center">
          <div className="w-96 border border-vector-blue bg-vector-bg shadow-card-glow">
            <div className="flex items-center justify-between px-5 py-4 border-b border-vector-blue/30">
              <span className="text-[10px] text-vector-blue font-mono tracking-widest uppercase font-bold">ADD_NODE</span>
            ...
            <div className="p-5 flex flex-col gap-4">
              <div>
                <label className="text-[8px] text-vector-white/40 font-mono uppercase tracking-widest block mb-1">Node Label *</label>
                <input
                  value={addLabel}
                  onChange={(e) => setAddLabel(e.target.value)}
                  onKeyDown={(e) => e.key === "Enter" && handleAddNode()}
                  placeholder="e.g. Bayes Theorem"
                  className="w-full bg-black/60 border border-vector-blue/30 px-3 py-2.5 text-vector-white text-[11px] font-mono outline-none focus:border-vector-blue transition-colors"
                  autoFocus
                />
              </div>
              <div>
                <label className="text-[8px] text-vector-white/40 font-mono uppercase tracking-widest block mb-1">Description (optional)</label>
                <textarea
                  value={addDesc}
                  onChange={(e) => setAddDesc(e.target.value)}
                  rows={3}
                  placeholder="Brief description of this topic..."
                  className="w-full bg-black/60 border border-vector-blue/30 px-3 py-2 text-vector-white/70 text-[10px] font-mono leading-relaxed resize-none outline-none focus:border-vector-blue transition-colors"
                />
              </div>
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 bg-vector-blue text-vector-bg text-[10px] font-bold tracking-widest uppercase font-mono hover:brightness-110 transition-all disabled:opacity-40"
                >
                  ADD TO TREE
                </button>
                <button
                  onClick={() => { setShowAddForm(false); setAddLabel(""); setAddDesc(""); }}
                  className="px-4 py-3 border border-vector-blue/30 text-vector-blue text-[10px] font-mono tracking-widest uppercase hover:bg-vector-blue/10 transition-all"
                >
                  CANCEL
                </button>
              </div>
